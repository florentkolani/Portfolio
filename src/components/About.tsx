...
const About = () => {
    return (
        <div className="bg-base-300 mb-10 p-4 md:mb-32" id="About">
            <Title title="A propos" />
            <div className="md:h-screen flex justify-center items-center">
                <div className="hidden md:block">
                <img src={image} alt="" className="w-96 h-96 object-cover rounded-xl"/>
                </div>
                <div className="md:ml-4 space-y-4">
                    {aboutSection.map((section) => (
                        <div key={section.id} className="flex flex-col md:flex-row items-center mb-4 bg-base-100 p-4 rounded-xl md:w-[32rem] shadow-xl">
